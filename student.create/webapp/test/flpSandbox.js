		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생정보 생성하기",
									"targetURL": "#syncc25studentcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc25studentcreate-display": {
								"semanticObject": "syncc25studentcreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c25.student.create",
									"url": sap.ui.require.toUrl("sync/c25/student/create")
								}
							}
						}
					}
