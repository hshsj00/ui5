		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "화면 이동에 대한 연습",
									"targetURL": "#syncc25routing-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc25routing-display": {
								"semanticObject": "syncc25routing",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c25.routing",
									"url": sap.ui.require.toUrl("sync/c25/routing")
								}
							}
						}
					}
