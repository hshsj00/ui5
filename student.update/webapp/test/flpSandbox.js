		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생 정보 수정하기",
									"targetURL": "#syncc25studentupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc25studentupdate-display": {
								"semanticObject": "syncc25studentupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c25.student.update",
									"url": sap.ui.require.toUrl("sync/c25/student/update")
								}
							}
						}
					}
