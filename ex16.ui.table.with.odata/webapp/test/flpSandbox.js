		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sap.ui.table.Table을 oData Service와 함께 사용하기 ",
									"targetURL": "#syncc25ex16uitablewithodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc25ex16uitablewithodata-display": {
								"semanticObject": "syncc25ex16uitablewithodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c25.ex16.ui.table.with.odata",
									"url": sap.ui.require.toUrl("sync/c25/ex16/ui/table/with/odata")
								}
							}
						}
					}
