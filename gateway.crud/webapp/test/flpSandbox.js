		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD Mentoring",
									"targetURL": "#syncc25gatewaycrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc25gatewaycrud-display": {
								"semanticObject": "syncc25gatewaycrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c25.gateway.crud",
									"url": sap.ui.require.toUrl("sync/c25/gateway/crud")
								}
							}
						}
					}
