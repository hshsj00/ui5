		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "oData Servie를 사용해서 데이터 출력하기",
									"targetURL": "#syncc25odataservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc25odataservice-display": {
								"semanticObject": "syncc25odataservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c25.odata.service",
									"url": sap.ui.require.toUrl("sync/c25/odata/service")
								}
							}
						}
					}
