sap.ui.define([
    ...
    return Controller.extend("sync.c25.student.delete.controller.Main", {
        onInit() {
        },
        onDelete: function(oEvent) {
            ...
            // alert("내가 클릭한 버튼의 모델의 특정 데이터 경로:"+sPath);

            //oData model 을 가져온다.
            //왜 ? oData Model을 가져온다고 말할 수 있는가?
            //manifeat.json에서 그 이유를 증명할 수 있다.
            //이름이 공백("")으로 되어 있는 모델이 있다.
            //manifest.josn에서 속성 중 sap.app 속성에는
            //dataSource들이 모여있는 dataSources가 있다.
            //해당 속성을 찾아가면, mainService가 기록되어 있다.
            //그 서비스의 타입을 살펴보면, oData라고 되어있다. 
