		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생명단제거",
									"targetURL": "#syncc25studentdelete-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc25studentdelete-display": {
								"semanticObject": "syncc25studentdelete",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c25.student.delete",
									"url": sap.ui.require.toUrl("sync/c25/student/delete")
								}
							}
						}
					}
